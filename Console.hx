...
class Console extends DraggableWindow
{
	...
	{
		super(x, y, width, height,0x000000,eventDispatcher,false);
		
		command = "";
		
		font = Assets.getFont("assets/fonts/" + "console.ttf");
		
		var format = new TextFormat (font.fontName,16, 0xFFFFFF);
		var format2 = new TextFormat (font.fontName,16, 0xFFFFFF);
	...
	{
		/*if (cursorTimer >= MathHelper.ConvertSecToMillisec(CURSOR_TIME))
		{
			if (cursorOn)
